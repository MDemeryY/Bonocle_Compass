...
class DegreeScaleView: UIView {
    ...
    private lazy var levelView: UIView = {
        ...
        levelView.backgroundColor = #colorLiteral(red: 0.1153066382, green: 0.2319532037, blue: 0.3340672851, alpha: 1)
        return levelView
    }()
    ...
    private lazy var verticalView: UIView = {
        ...
        verticalView.backgroundColor = #colorLiteral(red: 0.1153066382, green: 0.2319532037, blue: 0.3340672851, alpha: 1)
        return verticalView
    }()
    
    private lazy var lineView: UIView = {
        let lineView = UIView(frame: CGRect(x: self.frame.size.width / 2 - 1.5, y: 20, width: 3, height: 60))
        lineView.backgroundColor = #colorLiteral(red: 0.1153066382, green: 0.2319532037, blue: 0.3340672851, alpha: 1)
        return lineView
    }()
    ...
    private func configScaleDial() {
        ...
        for i in 0 ..< 180 {
            ...
            if i % 15 == 0 {
                ...
                label.center = point
                label.text = tickText
                label.textColor = #colorLiteral(red: 0.1153066382, green: 0.2319532037, blue: 0.3340672851, alpha: 1)
                ...
                if i % 45 == 0 {
                    ...
                    label2.textColor = #colorLiteral(red: 0.1153066382, green: 0.2319532037, blue: 0.3340672851, alpha: 1)
